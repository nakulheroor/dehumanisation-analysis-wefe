...
from wefe_news_analysis.wefe_runner import export_wefe_results, load_embeddings, run_all_wefe, train_embeddings
...
def test_run_all_wefe_and_export_results(monkeypatch, tmp_path: Path) -> None:
    ...
    class FakeMetric:
        def run_query(self, query, model, return_effect_size=True):
            return {
